...
--- Core build script for directional whips and lash-based weaponry.
--- Manages segmental physics metadata, specialized projectile offset mapping,
--- and localized localization for unique lash abilities and tip-effects.
